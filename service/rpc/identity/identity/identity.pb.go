...
var file_identity_proto_rawDesc = []byte{
	...
	0x12, 0x0e, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	...
	,
...
var file_identity_proto_goTypes = []interface{}{
	(*GenerateTokenReq)(nil),  // 0: identityclient.GenerateTokenReq
	(*GenerateTokenResp)(nil), // 1: identityclient.GenerateTokenResp
	(*ClearTokenReq)(nil),     // 2: identityclient.ClearTokenReq
	(*ClearTokenResp)(nil),    // 3: identityclient.ClearTokenResp
	(*ValidateTokenReq)(nil),  // 4: identityclient.ValidateTokenReq
	(*ValidateTokenResp)(nil), // 5: identityclient.ValidateTokenResp
}
var file_identity_proto_depIdxs = []int32{
	0, // 0: identityclient.identity.generateToken:input_type -> identityclient.GenerateTokenReq
	2, // 1: identityclient.identity.clearToken:input_type -> identityclient.ClearTokenReq
	4, // 2: identityclient.identity.validateToken:input_type -> identityclient.ValidateTokenReq
	1, // 3: identityclient.identity.generateToken:output_type -> identityclient.GenerateTokenResp
	3, // 4: identityclient.identity.clearToken:output_type -> identityclient.ClearTokenResp
	5, // 5: identityclient.identity.validateToken:output_type -> identityclient.ValidateTokenResp
...
func (c *identityClient) GenerateToken(ctx context.Context, in *GenerateTokenReq, opts ...grpc.CallOption) (*GenerateTokenResp, error) {
	...
	err := c.cc.Invoke(ctx, "/identityclient.identity/generateToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityClient) ClearToken(ctx context.Context, in *ClearTokenReq, opts ...grpc.CallOption) (*ClearTokenResp, error) {
	...
	err := c.cc.Invoke(ctx, "/identityclient.identity/clearToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityClient) ValidateToken(ctx context.Context, in *ValidateTokenReq, opts ...grpc.CallOption) (*ValidateTokenResp, error) {
	...
	err := c.cc.Invoke(ctx, "/identityclient.identity/validateToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Identity_GenerateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/identityclient.identity/GenerateToken",
	}
...
func _Identity_ClearToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/identityclient.identity/ClearToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Identity_ValidateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/identityclient.identity/ValidateToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Identity_serviceDesc = grpc.ServiceDesc{
	ServiceName: "identityclient.identity",
